...
FROM (VALUES
    -- APOSTILAS (WIRE-O)
    (88, 'Wire-o'), (112, 'Wire-o'), (118, 'Wire-o'), 
    (105, 'Wire-o'), (104, 'Wire-o'), (114, 'Wire-o'), (117, 'Wire-o'),
    (86, 'Wire-o'), (160, 'Wire-o'), 
    (145, 'Wire-o'), (146, 'Wire-o'), (147, 'Wire-o'), (148, 'Wire-o'),
    (157, 'Wire-o'), (158, 'Wire-o'), (159, 'Wire-o'),

    -- APOSTILAS (ESPIRAL)
    (85, 'Espiral'), (87, 'Espiral'), (111, 'Espiral'), (115, 'Espiral'),
    (107, 'Espiral'), (113, 'Espiral'), (116, 'Espiral'),
    (106, 'Espiral'), (150, 'Espiral'), 
    (149, 'Espiral'), (155, 'Espiral'), (156, 'Espiral'),
    (161, 'Espiral'), (162, 'Espiral'), (164, 'Espiral'), (165, 'Espiral'),

    -- APOSTILAS (CAPA PP)
    (100, 'Encadernação PP'), (109, 'Encadernação PP'), (101, 'Encadernação PP'),
    ...
    -- LIVRETOS (COM E SEM CAPA)
    (120, 'Livreto c/ Capa'), (103, 'Livreto c/ Capa'), (121, 'Livreto c/ Capa'),
    (119, 'Livreto c/ Capa'), (122, 'Livreto c/ Capa'), (144, 'Livreto c/ Capa'),
    (171, 'Livreto c/ Capa'), (166, 'Livreto c/ Capa'), (168, 'Livreto c/ Capa'),
    (169, 'Livreto c/ Capa'), (172, 'Livreto c/ Capa'), (174, 'Livreto c/ Capa'),
    ...
    -- AVULSOS NOVOS (COUCHÊ E ADESIVO)
    (202, 'Papel Couchê'), (203, 'Papel Couchê'),
    (204, 'Adesivo'),

    -- AVULSOS PLASTIFICADOS
    (143, 'Plastificado'), (137, 'Plastificado'), (138, 'Plastificado'),
    (142, 'Plastificado'), (140, 'Plastificado'), (139, 'Plastificado'),
    (141, 'Plastificado'), (136, 'Plastificado'),
    ...
    -- AVULSOS OFFSET (Papel Padrão)
    (129, 'Papel Offset'), (128, 'Papel Offset'), (134, 'Papel Offset'), (133, 'Papel Offset'),
